import unittest
from pymodbus3.constants import ModbusPlusOperation
from pymodbus3.diag_message import *
from pymodbus3.diag_message import DiagnosticStatusRequest
from pymodbus3.diag_message import DiagnosticStatusResponse
from pymodbus3.diag_message import DiagnosticStatusSimpleRequest
from pymodbus3.diag_message import DiagnosticStatusSimpleResponse


class SimpleDataStoreTest(unittest.TestCase):
    """
    This is the unittest for the pymodbus3.diag_message module
    """
    ...
    def setUp(self):
        ...
        self.responses = [
            ...
            (ReturnSlaveNoResponseCountResponse, '\x00\x0f\x00\x00'),
    ...
    def test_diagnostic_simple_requests(self):
        ...
        self.assertRaises(NotImplementedError, lambda: request.execute())
    ...
    def tes_return_query_data_response(self):
        """ Testing diagnostic message execution """
