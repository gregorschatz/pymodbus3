...
class ModbusMeiMessageTest(unittest.TestCase):
    """
    This is the unittest for the pymodbus3.mei_message module
    """
    ...
    def test_read_device_information_response_encode(self):
        ...
        handle = ReadDeviceInformationResponse(
            read_code=DeviceInformation.Basic, information=data_set)
        result = handle.encode()
        self.assertEqual(result, message)
        self.assertEqual("ReadDeviceInformationResponse(1)", str(handle))

    def test_read_device_information_response_decode(self):
    ...
    def test_rtu_frame_size(self):
        ...
        result = ReadDeviceInformationResponse.calculate_rtu_frame_size(message)
