...
"""
from pymodbus3.interfaces import Singleton
from pymodbus3.constants import Defaults
from pymodbus3.utilities import rtu_frame_size
import struct
...
class ModbusPDU(object):
    ...
    @classmethod
    def calculate_rtu_frame_size(cls, buffer):
...
class ModbusRequest(ModbusPDU):
    ...
    def do_exception(self, exception):
